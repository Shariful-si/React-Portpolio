        ...
        <div className="container max-w-7xl mx-auto mt-20 text-white">
            ...
            <div className="flex justify-items-center mt-12">
                ...
                <div className="grid grid-row-5 justify-items-center p-6 gap-2 ">
                    {/* <!-- step-1 --> */}
                    <div className="shadow-lg rounded-lg max-w-xl mx-auto p-4 border h-96">
                ...
                <div className="grid grid-row-5 justify-items-center items-center">
                    <div className="mt-8">
                        <p className="px-4 py-2 bg-white text-black text-center rounded-full">1</p>
                    </div>
                    <div className="mt-8">
                        <p className="px-4 py-2 bg-white text-black text-center rounded-full">2</p>
                    </div>
                    <div className="mt-8">
                        <p className="px-4 py-2 bg-white text-black text-center rounded-full">3</p>
                    </div>
                    <div className="mt-8">
                        <p className="px-4 py-2 bg-white text-black text-center rounded-full">4</p>
                    </div>
                    <div className="mt-8">
                        <p className="px-4 py-2 bg-white text-black text-center rounded-full">5</p>
                    </div>
                </div>
                {/* <!-- Right side start --> */}
                <div className="grid grid-row-5 justify-items-center p-6 gap-2 ">
